...
bsub -n $NUM_CORES -W $RUN_TIME -R "rusage[mem=$MEM_PER_CORE, ngpus_excl_p=$NUM_GPUS]" -R "select[gpu_model0==GeForceRTX2080Ti]"
export XDG_RUNTIME_DIR=
IP_REMOTE="\$(hostname -i)"
echo "Remote IP:\$IP_REMOTE" >> /cluster/home/$USERNAME/jnbip
jupyter notebook --no-browser --ip "\$IP_REMOTE" --notebook-dir "~/cil_2021" &> /cluster/home/$USERNAME/jnbinfo 
ENDBSUB
